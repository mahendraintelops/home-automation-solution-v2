...
const (
	UserService_Ping_FullMethodName       = "/pb.UserService/Ping"
...
type UserServiceClient interface {
	Ping(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) Ping(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
type UserServiceServer interface {
	Ping(context.Context, *UserRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) Ping(context.Context, *UserRequest) (*UserResponse, error) {
...
func _UserService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Ping(ctx, req.(*UserRequest))
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/v1/user-api.proto",
}
